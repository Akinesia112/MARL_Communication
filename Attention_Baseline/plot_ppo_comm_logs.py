...
def main(
    log_path="ppo_comm_logs_ant_4x2.npz",
    out_dir="png/ppo_comm_ant_4x2",
):
    ...
    plt.tight_layout()
    reward_path = os.path.join(out_dir, "ppo_comm_reward.png")
    ...
    plt.grid(True, alpha=0.3)
    plt.tight_layout()
    loss_path = os.path.join(out_dir, "ppo_comm_loss.png")
    ...
    fig.tight_layout()
    sigma_path = os.path.join(out_dir, "ppo_comm_sigma_buffer.png")
