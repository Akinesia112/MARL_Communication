...
def load_policies(env, model_path, device, msg_len=4, vocab_size=8,
    ...
    print(f"✓ Loaded PPO Comm model from {model_path}")
    return policies
...
def evaluate_ppo_gat_comm(
    model_path="checkpoints_ppo_gat_comm_ant_4x2/ppo_gat_comm_best.pt",
    out_dir="videos",
    out_name="ppo_gat_comm_ant_4x2.mp4",
    mode="fixed_time",
