...
def main(
    log_path="ppo_gat_no_comm_logs_ant_4x2.npz",
    out_dir="png/ppo_gat_no_comm_ant_4x2",
):
    ...
    plt.ylabel("Reward")
    plt.title("PPO No-Comm: Reward Curve")
    plt.legend()
    plt.grid(True, alpha=0.3)
    plt.tight_layout()
    reward_path = os.path.join(out_dir, "ppo_gat_no_comm_reward.png")
    ...
    plt.xlabel("Iteration")
    plt.ylabel("Loss")
    plt.title("PPO No-Comm: Loss Curve")
    plt.legend()
    plt.grid(True, alpha=0.3)
    plt.tight_layout()
    loss_path = os.path.join(out_dir, "ppo_gat_no_comm_loss.png")
    ...
    plt.title("PPO No-Comm: Sigma & Buffer (dummy)")
    fig.tight_layout()
    sigma_path = os.path.join(out_dir, "ppo_gat_no_comm_sigma_buffer.png")
