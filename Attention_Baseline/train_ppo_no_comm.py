...
class NoCommPPOTrainer:
    def __init__(self, scenario="Ant", agent_conf="4x2", lr=1e-4, gamma=0.99):
        ...
        self.policies = {
            agent: GCNPolicyNoComm(obs_dim, action_dim, hidden_dim=args.hidden_dim).to(self.device)
        ...
        # checkpoints
        os.makedirs("checkpoints_ppo_no_comm_ant_4x2", exist_ok=True)
    ...
    def save_checkpoint(self, suffix):
        ...
        path = os.path.join("checkpoints_ppo_no_comm_ant_4x2", f"ppo_nocomm_{suffix}.pt")
    ...
    def train(self, n_iterations=1000, save_freq=50):
        ...
        for iteration in range(n_iterations):
            ...
            np.savez("ppo_no_comm_logs_ant_4x2.npz", **self.logs)
        ...
        np.savez("ppo_no_comm_logs_ant_4x2.npz", **self.logs)
        print("✓ Training logs saved to ppo_no_comm_logs_ant_4x2.npz")
