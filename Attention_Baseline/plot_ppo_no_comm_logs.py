...
def main(
    log_path="ppo_no_comm_logs_ant_4x2.npz",
    out_dir="png/ppo_no_comm_ant_4x2",
):
    ...
    plt.tight_layout()
    reward_path = os.path.join(out_dir, "ppo_nocomm_reward.png")
    ...
    plt.grid(True, alpha=0.3)
    plt.tight_layout()
    loss_path = os.path.join(out_dir, "ppo_nocomm_loss.png")
    ...
    fig.tight_layout()
    sigma_path = os.path.join(out_dir, "ppo_nocomm_sigma_buffer.png")
