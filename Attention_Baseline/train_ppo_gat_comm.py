...
from gnn_policies import GATPolicyComm
...
class CommPPOTrainer:
    def __init__(
        ...
        # ----- networks: GATPolicyComm + SimpleCritic -----
        self.policies = {
            agent: GATPolicyComm(
                obs_dim=obs_dim,
        ...
        # ----- checkpoints & logs -----
        self.ckpt_dir = "checkpoints_ppo_gat_comm_ant_4x2"
    ...
    def collect_rollout(self, n_steps=2048):
        ...
        for step in range(n_steps):
            ...
            for idx, agent in enumerate(self.agents):
                ...
                with torch.no_grad():
                    # GATPolicyComm(obs, all_obs, self_index)
    ...
    def save_checkpoint(self, suffix):
        ...
        path = os.path.join(self.ckpt_dir, f"ppo_gat_comm_{suffix}.pt")
    ...
    def train(self, n_iterations=1000, save_freq=50):
        ...
        for iteration in range(n_iterations):
            ...
            np.savez("ppo_gat_comm_logs_ant_4x2.npz", **self.logs)
        ...
        np.savez("ppo_gat_comm_logs_ant_4x2.npz", **self.logs)
        print("✓ Training logs saved to ppo_gat_comm_logs_ant_4x2.npz")
