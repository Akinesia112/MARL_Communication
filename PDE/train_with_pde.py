...
class MAMuJoCoTrainer:
    ...
    def save_checkpoint(self, iteration, best_reward):
        ...
        torch.save(checkpoint, f"checkpoints_pde/model_iter_{iteration}.pt")
...
if __name__ == "__main__":
    ...
    # 或從 checkpoint 恢復
    # trainer.train(n_iterations=1000, save_freq=50, resume_from="checkpoints_pde/model_iter_xxx.pt")