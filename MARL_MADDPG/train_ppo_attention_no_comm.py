...
class MAMuJoCoTrainer:
    def __init__(self, scenario="Ant", agent_conf="2x4", lr=3e-4, gamma=0.99):
        ...
        # --------- checkpoints & logs ---------
        self.ckpt_dir = "checkpoints_ppo_attention_no_comm"
    ...
    def train(self, n_iterations=1000, save_freq=50):
        ...
        for iteration in range(n_iterations):
            ...
            np.savez("ppo_attention_no_comm_logs.npz", **self.logs)
        ...
        np.savez("ppo_attention_no_comm_logs.npz", **self.logs)
        print("✓ Training logs saved to ppo_attention_no_comm_logs.npz")
