...
class MADDPGNoCommTrainer:
    def __init__(
        ...
        os.makedirs("checkpoints_maddpg_nocomm", exist_ok=True)
    ...
    def save_actors(self, suffix):
        ...
        path = os.path.join(
            "checkpoints_maddpg_nocomm", f"maddpg_nocomm_{suffix}.pt"
        )
    ...
    def train(self, n_episodes=1000, updates_per_step=1):
        ...
        np.savez("maddpg_nocomm_logs.npz", **self.logs)
        print("✓ Training logs saved to maddpg_nocomm_logs.npz")
