...
class MAMuJoCoTrainer:
    def __init__(self, scenario="Ant", agent_conf="2x4", lr=3e-4, gamma=0.99):
        self.checkpoint_dir = "checkpoints_attention_comm"
    ...
    def save_checkpoint(self, iteration):
        ...
        print(f"  ✓ 模型已保存到 checkpoints_attention_comm/model_iter_{iteration}.pt")
    ...
    def train(self, n_iterations=1000, save_freq=50):
        ...
        for iteration in range(n_iterations):
            ...
            np.savez("ppo_attention_comm_logs.npz", **self.logs)
